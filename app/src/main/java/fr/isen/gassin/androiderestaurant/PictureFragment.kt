...
import fr.isen.gassin.androiderestaurant.databinding.FragmentPictureBinding
...
class PictureFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Picasso.get().load(picture?.ifEmpty{null}).placeholder(R.drawable.mister_v).into(binding.pictureView)
    }
